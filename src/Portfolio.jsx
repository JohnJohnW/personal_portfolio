...
/* Liquid Glass portfolio — build-safe, GH Pages friendly */
    ...
    <section id={id} className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      {subtitle && (
        <motion.p
          ...
          className="mt-2 text-sm/6 text-neutral-700 dark:text-neutral-300"
        >
          {subtitle}
        </motion.p>
      )}
...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(1200px_800px_at_20%_-10%,rgba(59,130,246,.2),transparent),radial-gradient(1200px_800px_at_80%_110%,rgba(236,72,153,.15),transparent)] text-neutral-900 dark:text-neutral-100 selection:bg-indigo-500/30">
      <LiquidBlobs />
      <Spotlight />

      {/* Top nav */}
      <header className="sticky top-4 z-50 mx-auto max-w-6xl px-4">
        <div className="backdrop-blur-xl bg-white/10 dark:bg-black/20 border border-white/30 dark:border-white/10 shadow-lg rounded-2xl">
            ...
            <nav className="hidden sm:flex items-center gap-1">
              {[
                ...
                <button
                  ...
                  className={cn(
                    "px-3 py-2 rounded-xl text-sm hover:bg-white/30 hover:dark:bg-white/10 transition",
                    active === t.id && "bg-white/40 dark:bg-white/10"
                  )}
                >
                  {t.label}
                </button>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <motion.p
              ...
              className="mt-4 text-base/7 text-neutral-700 dark:text-neutral-300"
            >
              {DATA.blurb}
            </motion.p>
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 dark:bg-black/20 px-4 py-2 backdrop-blur-xl hover:bg-white/30 transition"
              >
            ...
            <div className="mt-6 flex gap-3">
              {DATA.socials.map((s) => (
                <a key={s.label} href={s.href} target="_blank" rel="noreferrer" className="group">
                  <div className="h-10 w-10 grid place-items-center rounded-xl border border-white/20 bg-white/10 dark:bg-black/20 backdrop-blur-xl group-hover:bg-white/30 transition">
          ...
          <div className="relative">
            <Tilt>
              <motion.div
                ...
                transition={{ delay: 0.1 }}
                className="relative rounded-3xl border border-white/30 dark:border-white/10 bg-white/10 dark:bg-black/20 backdrop-blur-xl p-6 shadow-2xl"
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-neutral-300">Hi, I’m</p>
                ...
                <div className="mt-5 grid grid-cols-3 gap-3">
                  {["Python", "TypeScript", "React", "FastAPI", "n8n", "OpenAI"].map((sk) => (
                    <div
                      key={sk}
                      className="rounded-2xl border border-white/20 bg-white/10 dark:bg-black/20 p-3 text-center text-sm"
                    >
                      {sk}
                    </div>
                  ))}
                ...
                <div className="mt-5 flex items-center justify-between gap-3">
                  <div className="text-sm text-neutral-300">Open to consulting • {DATA.location}</div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {DATA.projects.map((p, i) => (
            <motion.article
              ...
              className="relative group rounded-3xl border border-white/30 dark:border-white/10 bg-white/10 dark:bg-black/20 backdrop-blur-xl p-5 hover:border-white/50 hover:shadow-xl transition"
            >
              <div className="flex items-center justify-between gap-3">
                <h3 className="font-semibold">{p.title}</h3>
                <span className="text-xs text-neutral-300">{p.tag}</span>
              </div>
              <p className="mt-2 text-sm/6 text-neutral-200/90">{p.desc}</p>
              <div className="mt-4 flex flex-wrap gap-2">
                {p.stack.map((s) => (
                  <span key={s} className="text-xs rounded-lg border border-white/20 bg-white/10 px-2 py-1">
                    {s}
                  </span>
                ))}
              </div>
              ...
              <div
                ...
                style={{
                  background:
                    "conic-gradient(from 180deg at 50% 50%, rgba(99,102,241,.25), rgba(236,72,153,.25), rgba(14,165,233,.25), rgba(99,102,241,.25))",
                }}
              />
            </motion.article>
          ))}
      ...
      <Section id="videos" title="Videos" icon={PlaySquare} subtitle="Latest uploads from my YouTube channel.">
        <div className="rounded-3xl overflow-hidden border border-white/30 dark:border-white/10 bg-white/5 backdrop-blur-xl">
        ...
        <div className="mt-6 flex justify-end">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-sm inline-flex items-center gap-2 rounded-xl border border-white/40 bg-white/10 px-3 py-2 backdrop-blur-xl hover:bg-white/30"
          >
        ...
        <div className="relative">
          ...
          <ul className="space-y-6">
            {[
              ...
              >
                <div className="absolute left-0 top-1.5 h-6 w-6 rounded-xl bg-gradient-to-br from-indigo-500 via-fuchsia-500 to-sky-500 border border-white/30" />
                <div className="rounded-2xl border border-white/20 bg-white/10 dark:bg-black/20 backdrop-blur-xl p-4">
                  <div className="flex items-center justify-between">
                    <p className="font-medium">
                      {e.role} • {e.org}
                    </p>
                    <span className="text-xs text-neutral-300">{e.when}</span>
                  </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true, amount: 0.5 }}
          className="relative overflow-hidden rounded-3xl border border-white/30 dark:border-white/10 bg-gradient-to-tr from-indigo-500/20 via-fuchsia-500/20 to-sky-500/20 backdrop-blur-xl p-6"
        >
          <div
            className="absolute inset-0 pointer-events-none mix-blend-overlay opacity-60"
            style={{
              background:
                "url('data:image/svg+xml;utf8, %3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" stroke=\"white\" stroke-opacity=\"0.06\"%3E%3Cpath d=\"M0 30h60M30 0v60\"/%3E%3C/g%3E%3C/svg%3E')",
            }}
          />
          <div className="relative z-10 grid md:grid-cols-2 gap-6 items-center">
            <div>
              <h3 className="text-xl font-semibold">Let’s build something audacious.</h3>
              <p className="mt-2 text-sm text-neutral-100/90">
            ...
            <div className="flex md:justify-end gap-3">
              <a
                href="#contact"
                onClick={scrollTo("contact")}
                className="inline-flex items-center gap-2 rounded-xl bg-white/90 text-neutral-900 px-4 py-2 hover:bg-white"
              >
                <Wand2 className="h-4 w-4" /> Start a project
              </a>
              <a
                href={DATA.resume}
                className="inline-flex items-center gap-2 rounded-xl border border-white/40 bg-white/10 px-4 py-2 backdrop-blur-xl hover:bg-white/30"
              >
        ...
        <motion.form
          ...
          onSubmit={(e) => {
            ...
            try {
              ...
              window.location.href = `mailto:johnwynter55893@outlook.com?subject=${subject}`;
            } finally {
              // toast handled above
            }
          }}
          className="grid md:grid-cols-2 gap-4 rounded-3xl border border-white/30 dark:border-white/10 bg-white/10 dark:bg-black/20 backdrop-blur-xl p-6"
        >
          <div className="grid gap-3">
            <label className="text-sm">
              ...
              <input
                name="name"
                required
                className="mt-1 w-full rounded-xl bg-black/10 dark:bg-black/30 border border-white/20 px-3 py-2 outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </label>
            <label className="text-sm">
              Email
            ...
            <label className="text-sm">
              ...
              <select
                name="budget"
                className="mt-1 w-full rounded-xl bg-black/10 dark:bg-black/30 border border-white/20 px-3 py-2"
              >
      ...
      <AnimatePresence>
        {false && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[60] rounded-2xl border border-white/30 bg-white/70 dark:bg-black/60 backdrop-blur-xl px-4 py-2 shadow-xl"
          >
            Sent!
          </motion.div>
        )}
