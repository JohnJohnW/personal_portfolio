    ...
    <section id={id} className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      {subtitle && (
        <motion.p initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }}
          className="mt-2 text-sm/6 text-neutral-700 dark:text-neutral-300">{subtitle}</motion.p>
      )}
    ...
    <div className="min-h-screen bg-[radial-gradient(1200px_800px_at_20%_-10%,rgba(59,130,246,.2),transparent),radial-gradient(1200px_800px_at_80%_110%,rgba(236,72,153,.15),transparent)] text-neutral-900 dark:text-neutral-100 selection:bg-indigo-500/30">
            ...
            <nav className="hidden sm:flex items-center gap-1">
              {[
                ...
                <button key={t.id} onClick={scrollTo(t.id)}
                  className={cn("px-3 py-2 rounded-xl text-sm hover:bg-white/30 hover:dark:bg-white/10 transition",
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
              className="mt-4 text-base/7 text-neutral-700 dark:text-neutral-300">{DATA.blurb}</motion.p>
              ...
              <motion.div initial={{ opacity: 0, scale: .96 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.1 }}
                ...
                <div className="mt-5 grid grid-cols-3 gap-3">
                  {['Python','TypeScript','React','FastAPI','n8n','OpenAI'].map((sk) => (
                    <div key={sk} className="rounded-2xl border border-white/20 bg-white/10 dark:bg-black/20 p-3 text-center text-sm">
                      {sk}
                    </div>
                  ))}
                </div>
          ...
          {DATA.projects.map((p, i) => (
            <motion.article key={p.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ delay: i * 0.03 }}
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {p.stack.map((s) => (
                  <span key={s} className="text-xs rounded-lg border border-white/20 bg-white/10 px-2 py-1">{s}</span>
                ))}
              </div>
      ...
      <Section id="videos" title="Videos" icon={PlaySquare} subtitle="Latest uploads from my YouTube channel.">
        ...
        <div className="mt-6 flex justify-end">
          <a href="https://www.youtube.com/@john_wynter" target="_blank" rel="noreferrer" className="text-sm inline-flex items-center gap-2 rounded-xl border border-white/40 bg-white/10 px-3 py-2 backdrop-blur-xl hover:bg-white/30">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.98 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, amount: 0.5 }}
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="flex md:justify-end gap-3">
              ...
              <a href={DATA.resume} className="inline-flex items-center gap-2 rounded-xl border border-white/40 bg-white/10 px-4 py-2 backdrop-blur-xl hover:bg-white/30">
        ...
        <motion.form initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.4 }}
          ...
          <div className="grid gap-3">
            <label className="text-sm">Name
              <input name="name" required className="mt-1 w-full rounded-xl bg-black/10 dark:bg-black/30 border border-white/20 px-3 py-2 outline-none focus:ring-2 focus:ring-indigo-500" />
            </label>
            <label className="text-sm">Email
              <input name="email" type="email" required className="mt-1 w-full rounded-xl bg-black/10 dark:bg-black/30 border border-white/20 px-3 py-2 outline-none focus:ring-2 focus:ring-indigo-500" />
            </label>
            <label className="text-sm">Budget
              <select name="budget" className="mt-1 w-full rounded-xl bg-black/10 dark:bg-black/30 border border-white/20 px-3 py-2">
          ...
          <div className="grid gap-3">
            <label className="text-sm">Project details
              <textarea name="message" rows={7} className="mt-1 w-full rounded-xl bg-black/10 dark:bg-black/30 border border-white/20 px-3 py-2 outline-none focus:ring-2 focus:ring-indigo-500" placeholder="What are we building?" />
            </label>
